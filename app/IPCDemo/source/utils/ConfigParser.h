...
public:
    ...
    virtual AX_BOOL GetCameraHotNoiseBalanceCfg(SENSOR_HOTNOISEBALANCE_T &stOutCfg, SENSOR_ID_E eSensorID) = 0;
};
...
public:
    ...
    AX_BOOL GetCameraHotNoiseBalanceCfg(SENSOR_HOTNOISEBALANCE_T &stOutCfg, SENSOR_ID_E eSensorID);
