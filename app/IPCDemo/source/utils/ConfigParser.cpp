...
AX_BOOL CConfigParser::GetCameraHotNoiseBalanceCfg(SENSOR_HOTNOISEBALANCE_T &stOutCfg, SENSOR_ID_E eSensorID)
{
    if (m_pParser) {
        return m_pParser->GetCameraHotNoiseBalanceCfg(stOutCfg, eSensorID);
    }
