...
typedef struct {
    ...
    AX_ISP_3A_UNIT_T IntegrationTimeLimit; /* long frame sensor integration time limit */
    ...
    AX_ISP_3A_UNIT_T sIntegrationTime;   /* middle frame sensor integration time limit */
    AX_ISP_3A_UNIT_T sVsintegrationTime; /* short frame sensor integration time limit */
    ...
    AX_U32 linePeriodFixedPoint; /* Fixed point type line period */
    AX_F32 linePeriodFloat;      /* Float type line period, unit:us */
...
typedef struct {
    ...
    AX_F32 fIntegrationTime;        // Shutter
    // Below Unused on Tool, first defined, not used
    AX_F32 fSgain;
    AX_F32 fSdgain;
    AX_F32 fVsgain;
    AX_F32 fVsdgain;
    AX_F32 fSintegrationTime;
    AX_F32 fVsintegrationTime;
...
typedef struct {
    ...
    /* HDR max shutter */
    AX_F32 hdrHwMaxShutter;  /* hard limit: calc from hdrratio*/
    AX_F32 algoMaxShutter;   /* cur max shutter= min(hdrHwMaxShutter, maxUserShutter) */
...
AX_S32 sample_ae_init(AX_U8 pipe, AX_ISP_AE_INITATTR_T *pParam, AX_ISP_AE_RESULT_T *pAeResult);
