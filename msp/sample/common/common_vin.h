...
#ifdef SAMPLE_IRCUT
typedef struct _AX_SNS_IRCUT_ATTR_T_ {
    AX_F32   nIrCalibR;
    AX_F32   nIrCalibG;
    AX_F32   nIrCalibB;
    AX_F32   nNight2DayIrStrengthTh;
    AX_F32   nNight2DayIrDetectTh;
    AX_U32   nInitDayNightMode;
    AX_F32   nDay2NightLuxTh;
    AX_F32   nNight2DayLuxTh;
    AX_F32   nNight2DayBrightTh;
    AX_F32   nNight2DayDarkTh;
    AX_F32   nNight2DayUsefullWpRatio;
    AX_U32   nCacheTime;
} AX_SNS_IRCUT_ATTR_T;
#endif
...
AX_S32 COMMON_ISP_ResetSns(AX_U8 pipe, SAMPLE_SNS_TYPE_E eSnsType);
...
#ifdef SAMPLE_IRCUT
AX_S32 COMMON_ISP_GetIrCutAttr(SAMPLE_SNS_TYPE_E eSnsType, AX_SNS_IRCUT_ATTR_T *pSnsIrAttr);
#endif
