...
typedef struct {
...
#ifdef SAMPLE_IRCUT
    pthread_t           tIspIrThread;
    AX_SNS_IRCUT_ATTR_T stSnsIrAttr;
#endif
    ...
    /*eis*/
    AX_ISP_IQ_EIS_PARAM_T pIspEisParam;
    /* pfr */
    AX_ISP_IQ_PFR_PARAM_T tIspPfrParam;
    AX_ISP_IQ_NPU_PARAM_T tModelNmaeParm;
} CAMERA_T;
