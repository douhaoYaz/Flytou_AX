...
#ifdef SAMPLE_IRCUT
AX_SNS_IRCUT_ATTR_T gOs04a10SnsIrAttr = {
    .nIrCalibR = 1.056,
    .nIrCalibG = 1,
    .nIrCalibB = 1.036,
    .nNight2DayIrStrengthTh = 0.4,
    .nNight2DayIrDetectTh = 0.08,
    .nInitDayNightMode = 0,
    .nDay2NightLuxTh = 0.7,
    .nNight2DayLuxTh = 20.0,
    .nNight2DayBrightTh = 230.0,
    .nNight2DayDarkTh = 5.0,
    .nNight2DayUsefullWpRatio = 0.5,
    .nCacheTime = 2,
};
#endif
