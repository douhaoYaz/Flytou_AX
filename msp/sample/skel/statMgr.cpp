...
AX_VOID StatTrackMgr(const AX_SKEL_OBJECT_ITEM_S *pstObjectItems, STAT_OBJECT_NUM_T *pObjectNum) {
...
AX_VOID StatPushMgr(const AX_SKEL_OBJECT_ITEM_S *pstObjectItems, STAT_OBJECT_NUM_T *pObjectNum) {
    if (!pstObjectItems || !pObjectNum) {
        return;
    }
