...
static AX_VOID DrawPointInternal(YUV_IMAGE_S *pstImage, AX_U8 *y, AX_U8 *u, AX_U8 *v, AX_U16 x0, AX_U16 y0,
                                 YUV_COLOR eColor) {
    if (!pstImage) {
        return;
    }
...
AX_VOID DrawPoint(YUV_IMAGE_S *pstImage, AX_S16 x, AX_S16 y, AX_U8 nScale /* = 1*/, AX_S16 x_offset /* = 0*/,
...
AX_VOID DrawLine(YUV_IMAGE_S *pstImage, AX_S16 x0, AX_S16 y0, AX_S16 x1, AX_S16 y1, YUV_COLOR eColor /* = YUV_GREEN*/,
                 AX_U8 nScale /* = 1*/)
...
AX_VOID DrawRect(YUV_IMAGE_S *pstImage, AX_S16 x0, AX_S16 y0, AX_U16 w, AX_U16 h, YUV_COLOR eColor /* = YUV_GREEN*/) {
    if (w > 0 && h > 0) {
